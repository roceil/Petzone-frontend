...
<template>
  <div class="HomeView">
    ...
    <!-- banner -->
    <section class="container mt-[76px]">
      <div class="flex space-x-10 xl:justify-center">
        <!-- 圖片區塊 -->
        <img
          :src="banner_img"
          alt="banner_img"
          class="w-[520px] h-[290px] rounded-[10px] object-cover"
        />
      ...
      <!-- banner_bottom -->
      <img :src="banner_bottom" alt="" class="w-full mt-16" />
    </section>
